...
<body>
	...
	<sec:authorize access="isAuthenticated()">
		...
		<!-- edu.ict.ex.security.UserDetailsVO@464d4ee5 -->
		...
		<h1>갯수<sec:authentication property="principal.cart.count" /></h1>
		
		<p><a href="<c:url value="/loginInfo" />">로그인 정보 확인 방법 3 가지</a></p>
